document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = {
        ...
        downloadWebBtn: document.getElementById('downloadWebBtn')
    };
    ...
    const handlers = {
        ...
        convert: () => {
            ...
            elements.throneOutput.value = processedIps.map(ip => `ip:${ip}`).join('\n');
            elements.webOutput.value = processedIps.join('\\n');
        ...
        clearAll: () => {
            ...
            elements.throneOutput.value = '';
            elements.webOutput.value = '';
    ...
    elements.copyThroneBtn.addEventListener('click', () => utils.copyToClipboard(elements.throneOutput));
    elements.copyWebBtn.addEventListener('click', () => utils.copyToClipboard(elements.webOutput));
    ...
    elements.downloadThroneBtn.addEventListener('click', () => utils.downloadFile('throne_rules.txt', elements.throneOutput.value));
    elements.downloadWebBtn.addEventListener('click', () => utils.downloadFile('web_rules.txt', elements.webOutput.value));
